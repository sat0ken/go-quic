...
func _() {
	keyblock := quic.QuicKeyBlock{
		ServerKey: quic.StrtoByte("8b53e48e3b32f75dcd34b9363a0fd1bf"),
		ServerIV:  quic.StrtoByte("475542845fc09d191737dd70"),
	}
	packet := quic.StrtoByte("410000105391af6659528a0608870a0f71b8db45bf73fe653d0fa02f2cb1191f74891ad12255b75291c42f765b6c561c92af6f951ba68eaa0f7e5d74b5178636b1474c15a77bc254bb5123e06522f80a5ba611ab871bdaa6dc228d")

	//plain := quic.DecryptQuicPayload([]byte{0x00}, quic.StrtoByte("410000"), packet, keyblock)

	plain := quic.ProtectHeader(1, packet, keyblock.ServerKey, false)
...
func main() {
	...
	shortpacket := parsed[0].Packet.(quic.QuicShortHeader)
	...
	unpshort := unpPacket[0].Packet.(quic.QuicShortHeader)
...
func _() {
	...
	frames := quic.ParseQuicFrame(plain, 0)[0].(quic.CryptoFrames)
