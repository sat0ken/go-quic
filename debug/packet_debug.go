...
func _() {
	...
	header := quic.NewInitialPacket(qpack)
	fmt.Printf("initPacket is %x\n", header.ToHeaderByte(header, false))
}
...
func main() {
	...
	tlsinfo.QPacketInfo.SourceConnID = retryPacket.LongHeader.SourceConnID
